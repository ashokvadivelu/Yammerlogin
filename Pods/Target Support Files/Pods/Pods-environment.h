...
// YammerSDK
#define COCOAPODS_POD_AVAILABLE_YammerSDK
#define COCOAPODS_VERSION_MAJOR_YammerSDK 1
#define COCOAPODS_VERSION_MINOR_YammerSDK 3
#define COCOAPODS_VERSION_PATCH_YammerSDK 0
